...
<tr>
  ...
  <td><a href="MainServlet?command=mall_main" style="margin-right: 70px; color:white;"><font size="5em"><b>Shop</b></font></a></td>
  ...
  <input type="button" value="MyPage" class="log-button" onclick="location.href='MainServlet?command=mypage'">
<% } else { %>
